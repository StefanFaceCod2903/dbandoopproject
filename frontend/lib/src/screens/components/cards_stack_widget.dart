...
import 'package:frontend/src/screens/components/action_button_widget.dart';
import 'package:frontend/src/screens/components/drag_widget.dart';
...
class _CardsStackWidgetState extends State<CardsStackWidget>
  ...
  void initState() {
    super.initState();
    draggableItems = [
      ...StoreProvider.of<AppState>(context, listen: false).state.palsState.pals
    ];
            ...
            onAccept: (int index) {
              setState(() {
                ...
                store.dispatch(CreateConversation(
                    ...
                    "${draggableItems[index].id}",
                    "${draggableItems[index].vice_id}"));
                draggableItems.removeAt(index);
              });
            },
          ),
